...
**CSS-Magic**  A CSS only app showcasing, container layouts switching in response to different screen sizes.
...
> Add a link to your deployed project.
 ...
 [Live Link](https://r-ahmed2022.github.io/CSS-magic/)
...
```sh
  cd my-folder
  git clone https://github.com/r-ahmed2022/CSS-magic.git 
```
### Install
